...
활동명은 입력된 활동명을 그대로 사용하고 절대 임의로 변경하지 마세요.
형식: [활동명-A], [활동명-B], [활동명-C], [활동명-D]
예시)
[축구기능연습-A] 탁월한 기초 기술을 바탕으로 경기 상황에 맞는 전술을 구사하며 높은 수행 능력을 보임.
[축구기능연습-B] 기초 기술을 성실히 익히며 향상된 능력을 꾸준히 보임.
[축구기능연습-C] 반복 연습을 통해 기초 기술을 점진적으로 향상시키는 모습이 인상적임.
[축구기능연습-D] 기초 기술 습득에 꾸준히 노력하며 발전 가능성을 보임.
